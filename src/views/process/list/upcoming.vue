...
export default {
  ...
  methods: {
    ...
    toHandle(row, type) {
      this.$router.push({ name: 'ProcessListHandle', query: { workOrderId: row.id, processId: row.process, type }})
    },
    handleInversion(row) {
